...
public class MemberController {
  ...
  @ResponseBody
  public MemberDTO findid(@RequestParam("mname") String mname, @RequestParam("email") String email) {
    MemberDTO memdto;
    ...
    memdto = service.findid(map);
    if(memdto!=null) {
      System.out.println("아이디찾기성공"+memdto.toString());
    }else {
      System.out.println("실패"+memdto.toString());
    }
    return memdto;
  }  
  ...
  @ResponseBody
  public MemberDTO findpw(@RequestParam("id") String id, @RequestParam("mname") String mname) {
    MemberDTO memdto;
    ...
    memdto = service.findpw(map);
    if(memdto!=null) {
      System.out.println("패스워드찾기성공"+memdto.toString());
    }else {
      System.out.println("실패"+memdto.toString());
    }
    return memdto;
