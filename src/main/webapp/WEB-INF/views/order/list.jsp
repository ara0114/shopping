...
<head>
  ...
  <meta charset="utf-8">
   <script type="text/javascript">
     ...
     function producer(orderno,value){//비동기통신으로 업데이트처리
     ...
     function update(orderno, i){	//i는 인덱스
    	 let l = document.getElementById("choice-"+i).selectedIndex;    	
    	 let value = document.getElementById("choice-"+i).options[l].value;//선택한옵션의 value값 뽑아옴
