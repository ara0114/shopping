  ...
  <form class="form-horizontal" 
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-8">
        ...
        <button type="button" class="btn btn-default" onclick="location.href='/member/findidForm'">아이디 찾기</button>
        <button type="button" class="btn btn-default" onclick="location.href='/member/findpwForm'">패스워드 찾기</button>
      </div>
    </div>
  </form>
